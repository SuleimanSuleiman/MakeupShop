        ...
        <section class="w-full h-screen flex justify-start items-center">
            ...
            <div class="flex-[70%] w-full h-full">
                ...
                <div class="py-12 px-4">
                    <h1 class="text-2xl text-gray-700 font-semibold my-4">Edit Category</h1>
                    <form action="{{route('admin.sub-category.update',$category->id)}}" method="post" autocomplete="off" class="w-full max-w-xl ">
                        @method('PUT')
                        @csrf
                        <div class="flex flex-wrap -mx-3 mb-6">
                            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                                ...
                                <x-text-input id="title_en" class="block mt-1 w-full"
                                                type="text"
                                                name="title_en"
                                                :value="$category->getTranslations('title')['en']"
                                                required />
                            ...
                            <div class="w-full md:w-1/2 px-3">
                                ...
                                <x-text-input id="title_ar" class="block mt-1 w-full"
                                                type="text"
                                                name="title_ar"
                                                :value="$category->getTranslations('title')['ar']"
                                                required />
