<x-category-layout>
            ...
            {{-- sidbare --}}
            <x-sidbare stage="Show Sub Categories" btn="false"/>
            {{-- setting --}}
                ...
                <div class="p-4">
                    ...
                    <div class="border-b-2 border-gray-300 py-2 flex items-center ">
                        <small class="hover:cursor-pointer underline">
                            <a href={{route('admin.sub-category.index')}}>Resell All</a>
                        </small>
                        <form action={{route('admin.searchSubCategory')}} class="text-end relative mx-auto min-w-[400px]">
                            ...
                            <div class="relative">
                                ...
                                <input   autocomplete="false" data-category="sub" name="value" type="search" id="search" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-200 rounded-lg bg-white " placeholder="Search Category..." required>
                    ...
                    <section class="max-w-[1120px] h-full mt-4  border-gray-600">
                        <div class="min-h-[70vh] ">
                            ...
                            <section class="flex justify-start items-center h-10 p-2 bg-gray-200">
                                <div id="checkboxAll" class="flex-[5%]  text-gray-700"><input class="hover:cursor-pointer" type="checkbox"></div>
                                <p class="flex-[10%]  font-semibold mr-4 text-gray-700">Title</p>
                                <p class="flex-[55%] font-semibold mr-4 text-gray-700">Description</p>
                                <p class="flex-[15%] font-semibold  mr-4 text-gray-700">Control</p>
                                <p class="flex-[15%] font-semibold  mr-4 text-gray-700">Main Category</p>
                                <p class="flex-[5%] font-semibold text-gray-700">Action</p>
                            </section>
                            {{-- body --}}
                            @foreach($paginator as $pagin)
                                <section id="body" class="flex justify-start items-center p-2 bg-white border-x-2 border-b-2 border-gray-200">
                                    ...
                                    <p class="flex-[55%] font-[100] text-[14px] h-full pr-12 overflow-y-auto mr-4 flex items-center">{{$pagin->desc}}</p>
                                    <div data-index={{$pagin->id}} data-category="sub" id="activeButton"  class="active flex flex-[15%] font-[100] text-[12px] hover:cursor-pointer mr-4">
                                    ...
                                    <div class="flex-[15%] mr-4 text-gray-700 ">
                                        <a
                                        class="font-[100] text-[14px] h-full overflow-y-auto mr-4 flex items-center underline  after:w-3 after:h-3 after:rounded-full after:absolute after:right-36 {{$pagin->BelongTOMainCategory->active?'after:bg-green-800':'after:bg-red-600'}}"
                                         href={{ route('admin.main-category.show', ['main_category'=>$pagin->category_id]) }}
                                         >
                                         {{$pagin->BelongTOMainCategory->title}}
                                        </a>
                                    </div>
