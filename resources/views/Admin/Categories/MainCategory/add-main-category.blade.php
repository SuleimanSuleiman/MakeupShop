            ...
            <div class="flex-[90%] w-full h-full  bg-gray-100 pl-4">
                ...
                <div class="py-12 px-4">
                    ...
                    <form action={{route('admin.main-category.store')}} method="POST" class="w-full">
                        ...
                        <div class="flex flex-wrap justify-start items-center -mx-3 mb-2">
                            {{-- state --}}
                            <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0  ml-4  bg-white p-4 rounded-lg shadow-sm shadow-gray-500">
