    ...
    {{-- desc --}}
        <div class="flex-[30%] px-3 mb-6 md:mb-0 bg-white p-4 rounded-lg shadow-sm shadow-gray-500">
            ...
            <div class="p-4 border border-gray-300 rounded-md">
                ...
                <x-text-area id="desc" class="block mt-1 w-full"
                    type="text"
                    name="desc"
                    required autocomplete="new-name" ></x-text-area>
        ...
        {{-- Quantity --}}
         <div class="flex-[30%] flex flex-col justify-between px-3 mb-6 md:mb-0 bg-white p-4 rounded-lg shadow-sm shadow-gray-500">
            ...
            <div class="p-4 border border-gray-300 rounded-md">
                <x-input-label for="Color" value="Product Price $" class="text-base  text-gray-600 opacity-90 mb-2" />
                <x-text-input id="Color" class="block mt-1 w-full px-1"
                    type="number"
                    step="0.01"
                    name="price"
                    required
