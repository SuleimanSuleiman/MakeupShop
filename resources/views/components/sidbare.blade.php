@props(['stage','btn' => true])
    <div id="mySidebar" class="transition-all duration-700 " style="width: 250px">
        <div  class="fixed top-0 left-0 z-50" >
                <div id="ContainerSidbar" class="relative w-56 bg-white h-screen overflow-y-auto p-2 z-50 shadow-md shadow-gray-600 transition-all duration-700 ">
                    {{-- arrow --}}
                    @if ($btn == 'true')
